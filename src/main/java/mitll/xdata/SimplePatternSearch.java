...
public class SimplePatternSearch implements FL_PatternSearch {
    ...
    private static final boolean USE_H2_KIVA = true;
     ...
     * @throws Exception
     */
    public SimplePatternSearch(String database, boolean useMysql) throws Exception {
    ...
    public SimplePatternSearch(String database, String username, String password) throws Exception {
